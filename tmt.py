...
if __name__ == "__main__":
  ...
  parser.add_argument("--train_steps", type=int, default=1000, help="Total number of training steps.")
  ...
  parser.add_argument("--num_shards", type=int, default=8, help="Number of shards (TPU chips).")
